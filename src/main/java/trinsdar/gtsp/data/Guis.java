...
import trinsdar.gtsp.gui.ButtonOverlays;

import static muramasa.antimatter.gui.ButtonBody.*;
import static muramasa.antimatter.gui.SlotType.*;
import static muramasa.antimatter.machine.Tier.*;
import static trinsdar.gtsp.data.GT4RData.COVER_CONVEYOR;
import static trinsdar.gtsp.data.GT4RData.COVER_PUMP;
import static trinsdar.gtsp.data.Machines.*;
import static trinsdar.gtsp.data.SlotTypes.DISPLAY;
import static trinsdar.gtsp.gui.ButtonOverlays.*;
import static trinsdar.gtsp.gui.ButtonOverlays.EXPORT;
import static trinsdar.gtsp.gui.ButtonOverlays.IMPORT;

public class Guis {

    public static GuiData MULTI_DISPLAY = new GuiData("gtsp", "multi_display").add(IT_IN, 17, 16).add(IT_IN, 35, 16).add(IT_IN, 53, 16).add(IT_IN, 17, 34).add(IT_IN, 35, 34).add(IT_IN, 53, 34).add(IT_OUT, 107, 16).add(IT_OUT, 125, 16).add(IT_OUT, 143, 16).add(IT_OUT, 107, 34).add(IT_OUT, 125, 34).add(IT_OUT, 143, 34).add(FL_IN, 17, 63).add(FL_IN, 35, 63).add(FL_IN, 53, 63).add(FL_OUT, 107, 63).add(FL_OUT, 125, 63).add(FL_OUT, 143, 63);
    public static GuiData MULTI_DISPLAY_MORE_FLUID = new GuiData("gtsp", "multi_display_more_fluid").add(IT_IN, 17, 16).add(IT_IN, 35, 16).add(IT_IN, 53, 16).add(IT_IN, 17, 34).add(IT_IN, 35, 34).add(IT_IN, 53, 34).add(IT_OUT, 107, 25).add(IT_OUT, 125, 25).add(IT_OUT, 143, 25).add(FL_IN, 17, 63).add(FL_IN, 35, 63).add(FL_IN, 53, 63).add(FL_OUT, 107, 63).add(FL_OUT, 125, 63).add(FL_OUT, 143, 63).add(FL_OUT, 107, 45).add(FL_OUT, 125, 45).add(FL_OUT, 143, 45);
    public static GuiData MULTI_DISPLAY_COMPACT = new GuiData("gtsp", "multi_display").add(MULTI_DISPLAY).setPadding(0, 0, 0, 0);
    public static GuiData BASIC_TANK = new GuiData("gtsp", "basic_tank").add(CELL_IN, 80, 17).add(CELL_OUT, 80, 53).add(FL_IN, 60, 43);

    public static GuiData ORE_BYPRODUCTS = new GuiData("gtsp", "ore_byproducts") {
        @Override
