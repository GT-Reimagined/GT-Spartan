...
import trinsdar.gtsp.machine.HatchMachineCustom;
import trinsdar.gtsp.machine.MaterialMachine;
import trinsdar.gtsp.machine.StorageMachine;
import trinsdar.gtsp.tile.single.TileEntityCoalBoiler;
import trinsdar.gtsp.tile.single.TileEntityInfiniteFluid;
import trinsdar.gtsp.tile.single.TileEntityQuantumChest;
import trinsdar.gtsp.tile.single.TileEntityQuantumTank;
import trinsdar.gtsp.tile.single.TileEntitySteamMachine;
import trinsdar.gtsp.Ref;
import trinsdar.gtsp.tile.multi.*;
...
import static trinsdar.gtsp.data.GT4RData.COVER_DYNAMO_OLD;
import static trinsdar.gtsp.data.GT4RData.COVER_FUSION_INPUT;
import static trinsdar.gtsp.data.GT4RData.COVER_FUSION_OUTPUT;
import static trinsdar.gtsp.data.GT4RData.COVER_STEAM_VENT;
import static trinsdar.gtsp.data.RecipeMaps.*;
