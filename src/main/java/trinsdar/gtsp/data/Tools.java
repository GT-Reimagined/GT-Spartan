...
public class Tools {
    ...
    public static AntimatterToolType DAGGER = new GTSPToolType(Ref.ID, "dagger", 2, 1, 10, 1.5F, -1.5F, WeaponTraits.THROWABLE).setToolClass(MaterialSwordSp.class);
    ...
    public static AntimatterToolType RAPIER = new GTSPToolType(Ref.ID, "rapier", 2, 1, 10, 0.0F, -1.6F, WeaponTraits.DAMAGE_ABSORB_25, WeaponTraits.EXTRA_DAMAGE_3_NO_ARMOUR).setToolClass(MaterialSwordSp.class);
    ...
    public static AntimatterToolType SPEAR = new GTSPToolType(Ref.ID, "spear", 2, 1, 10, 3.5F, -2.6F, WeaponTraits.REACH_1).setToolClass(MaterialSwordSp.class);
    public static AntimatterToolType HALBERD = new GTSPToolType(Ref.ID, "halberd", 2, 1, 10, 5.0F, -2.8F, WeaponTraits.TWO_HANDED_2, WeaponTraits.REACH_1, WeaponTraits.SHIELD_BREACH).setToolClass(MaterialSwordSp.class);
    public static AntimatterToolType PIKE = new GTSPToolType(Ref.ID, "pike", 2, 1, 10, 3.0F, -2.6F, WeaponTraits.TWO_HANDED_1, WeaponTraits.REACH_2).setToolClass(MaterialSwordSp.class);
    public static AntimatterToolType LANCE = new GTSPToolType(Ref.ID, "lance", 2, 1, 10, 3.0F, -3F, WeaponTraits.TWO_HANDED_2, WeaponTraits.REACH_1, WeaponTraits.SHIELD_BREACH).setToolClass(MaterialSwordSp.class);
    public static AntimatterToolType BATTLEAXE = new GTSPToolType(Ref.ID, "battleaxe", 2, 1, 10, 5.0F, -3F, WeaponTraits.TWO_HANDED_1, WeaponTraits.VERSATILE).setToolClass(MaterialSwordSp.class).addToolTypes("axe");
    ...
    public static AntimatterToolType GLAIVE = new GTSPToolType(Ref.ID, "glaive", 2, 1, 10, 4.0F, -3F, WeaponTraits.TWO_HANDED_1, WeaponTraits.REACH_1, WeaponTraits.SWEEP_DAMAGE_NORMAL).setToolClass(MaterialSwordSp.class);
