...
public class ToolCrafting {
    ...
    private static void loadStandardToolRecipes(Consumer<FinishedRecipe> output, AntimatterRecipeProvider provider){
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(DAGGER.getId()), output, GTSPRef.ID, DAGGER.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, DAGGER.getToolStack(NULL, NULL), map2.apply(DAGGER), "FP", "HR");
        provider.addToolRecipe(TOOL_BUILDER.get(LONGSWORD.getId()), output, GTSPRef.ID, LONGSWORD.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, LONGSWORD.getToolStack(NULL, NULL), map2.apply(LONGSWORD), " P ", "FPH", "PRP");
        provider.addToolRecipe(TOOL_BUILDER.get(KATANA.getId()), output, GTSPRef.ID, KATANA.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, KATANA.getToolStack(NULL, NULL), map2.apply(KATANA), " FP", " PH", "R  ");
        provider.addToolRecipe(TOOL_BUILDER.get(SABER.getId()), output, GTSPRef.ID, SABER.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, SABER.getToolStack(NULL, NULL), map2.apply(SABER), " P ", "FPH", "PR ");
        provider.addToolRecipe(TOOL_BUILDER.get(RAPIER.getId()), output, GTSPRef.ID, RAPIER.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, RAPIER.getToolStack(NULL, NULL), map2.apply(RAPIER), " FP", "PPH", "RP ");
        provider.addToolRecipe(TOOL_BUILDER.get(GREATSWORD.getId()), output, GTSPRef.ID, GREATSWORD.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, GREATSWORD.getToolStack(NULL, NULL), map2.apply(GREATSWORD), "FPH", "PPP", "PRP");
        provider.addToolRecipe(TOOL_BUILDER.get(BATTLE_HAMMER.getId()), output, GTSPRef.ID, BATTLE_HAMMER.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, BATTLE_HAMMER.getToolStack(NULL, NULL), map2.apply(BATTLE_HAMMER), "PPP", "PPP", "FRH");
        provider.addToolRecipe(TOOL_BUILDER.get(WARHAMMER.getId()), output, GTSPRef.ID, WARHAMMER.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, WARHAMMER.getToolStack(NULL, NULL), map2.apply(WARHAMMER), " P ", "PPH", "FR ");
        provider.addToolRecipe(TOOL_BUILDER.get(SPEAR.getId()), output, GTSPRef.ID, SPEAR.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, SPEAR.getToolStack(NULL, NULL), map1.apply(SPEAR), "FPH", " R ");
        provider.addToolRecipe(TOOL_BUILDER.get(HALBERD.getId()), output, GTSPRef.ID, HALBERD.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, HALBERD.getToolStack(NULL, NULL), map1.apply(HALBERD), "FP ", "PPH", "PR ");
        provider.addToolRecipe(TOOL_BUILDER.get(PIKE.getId()), output, GTSPRef.ID, PIKE.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, PIKE.getToolStack(NULL, NULL), map1.apply(PIKE), "FPH", " R ", " R ");
        provider.addToolRecipe(TOOL_BUILDER.get(LANCE.getId()), output, GTSPRef.ID, LANCE.getId() + "_with" , "gtsp_weapons",
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(BATTLEAXE.getId()), output, GTSPRef.ID, BATTLEAXE.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, BATTLEAXE.getToolStack(NULL, NULL), map3, "PPP", "PrP", "FRH");
        provider.addToolRecipe(TOOL_BUILDER.get(FLANGED_MACE.getId()), output, GTSPRef.ID, FLANGED_MACE.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, FLANGED_MACE.getToolStack(NULL, NULL), map3, "FPP", " rP", "R H");
        provider.addToolRecipe(TOOL_BUILDER.get(GLAIVE.getId()), output, GTSPRef.ID, GLAIVE.getId() + "_with" , "gtsp_weapons",
                "has_wrench", in, GLAIVE.getToolStack(NULL, NULL), map1.apply(GLAIVE), " P ", "FPH", " R ");
        provider.addToolRecipe(TOOL_BUILDER.get(QUARTERSTAFF.getId()), output, GTSPRef.ID, QUARTERSTAFF.getId() + "_with" , "gtsp_weapons",
    ...
    private static void loadFlintToolRecipes(Consumer<FinishedRecipe> output, AntimatterRecipeProvider provider){
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(DAGGER.getId()), output, GTSPRef.ID, DAGGER.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, DAGGER.getToolStack(flint, NULL), map2, "P", "R");
        provider.addToolRecipe(TOOL_BUILDER.get(LONGSWORD.getId()), output, GTSPRef.ID, LONGSWORD.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, LONGSWORD.getToolStack(flint, NULL), map2, " P ", " P ", "PRP");
        provider.addToolRecipe(TOOL_BUILDER.get(KATANA.getId()), output, GTSPRef.ID, KATANA.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, KATANA.getToolStack(flint, NULL), map2, "  P", " P ", "R  ");
        provider.addToolRecipe(TOOL_BUILDER.get(SABER.getId()), output, GTSPRef.ID, SABER.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, SABER.getToolStack(flint, NULL), map2, " P", " P", "PR");
        provider.addToolRecipe(TOOL_BUILDER.get(RAPIER.getId()), output, GTSPRef.ID, RAPIER.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, RAPIER.getToolStack(flint, NULL), map2, "  P", "PP ", "RP ");
        provider.addToolRecipe(TOOL_BUILDER.get(GREATSWORD.getId()), output, GTSPRef.ID, GREATSWORD.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, GREATSWORD.getToolStack(flint, NULL), map2, " P ", "PPP", "PRP");
        provider.addToolRecipe(TOOL_BUILDER.get(BATTLE_HAMMER.getId()), output, GTSPRef.ID, BATTLE_HAMMER.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, BATTLE_HAMMER.getToolStack(flint, NULL), map2, "PPP", "PPP", " R ");
        provider.addToolRecipe(TOOL_BUILDER.get(WARHAMMER.getId()), output, GTSPRef.ID, WARHAMMER.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, WARHAMMER.getToolStack(flint, NULL), map2, " P", "PP", " R");
        provider.addToolRecipe(TOOL_BUILDER.get(SPEAR.getId()), output, GTSPRef.ID, SPEAR.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, SPEAR.getToolStack(flint, NULL), map1, "P", "R");
        provider.addToolRecipe(TOOL_BUILDER.get(HALBERD.getId()), output, GTSPRef.ID, HALBERD.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, HALBERD.getToolStack(flint, NULL), map1, " P", "PP", "PR");
        provider.addToolRecipe(TOOL_BUILDER.get(PIKE.getId()), output, GTSPRef.ID, PIKE.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, PIKE.getToolStack(flint, NULL), map1, "P", "R", "R");
        provider.addToolRecipe(TOOL_BUILDER.get(LANCE.getId()), output, GTSPRef.ID, LANCE.getId() + "_flint" , "gtsp_weapons",
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(BATTLEAXE.getId()), output, GTSPRef.ID, BATTLEAXE.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, BATTLEAXE.getToolStack(flint, NULL), map3, "PPP", "PrP", " R ");
        provider.addToolRecipe(TOOL_BUILDER.get(FLANGED_MACE.getId()), output, GTSPRef.ID, FLANGED_MACE.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, FLANGED_MACE.getToolStack(flint, NULL), map3, " PP", " rP", "R  ");
        provider.addToolRecipe(TOOL_BUILDER.get(GLAIVE.getId()), output, GTSPRef.ID, GLAIVE.getId() + "_flint" , "gtsp_weapons",
                "has_wrench", in, GLAIVE.getToolStack(flint, NULL), map1, "P", "P", "R");
        provider.addToolRecipe(TOOL_BUILDER.get(QUARTERSTAFF.getId()), output, GTSPRef.ID, QUARTERSTAFF.getId() + "_flint" , "gtsp_weapons",
