...
import trinsdar.gtsp.data.CustomTags;
...
import static trinsdar.gtsp.data.GT4RData.*;
import static trinsdar.gtsp.data.GT4RData.MotorLV;
import static trinsdar.gtsp.data.Materials.*;
import static trinsdar.gtsp.loader.crafting.CraftingHelper.of2;
