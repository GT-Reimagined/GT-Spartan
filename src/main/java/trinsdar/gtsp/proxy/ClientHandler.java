...
import trinsdar.gtsp.GT4Reimagined;
import trinsdar.gtsp.block.BlockCasing;
import trinsdar.gtsp.block.BlockMachineMaterial;
import trinsdar.gtsp.client.BakedModels;
import trinsdar.gtsp.data.GT4RData;
import net.minecraft.client.renderer.RenderType;
import net.minecraft.client.renderer.RenderTypeLookup;
import net.minecraftforge.fml.event.lifecycle.FMLClientSetupEvent;
import trinsdar.gtsp.data.Guis;
import trinsdar.gtsp.gui.ScreenButtonBackgroundCover;
import trinsdar.gtsp.gui.ScreenCoalBoiler;
import trinsdar.gtsp.gui.ScreenDistillationTower;
import trinsdar.gtsp.gui.ScreenFusionReactor;
import trinsdar.gtsp.gui.ScreenHatchCustom;
import trinsdar.gtsp.gui.ScreenIBF;
...
public class ClientHandler implements IProxyHandler {
    ...
    private static void copyProgrammerArtIfMissing() {
        ...
        //if(!target.exists())
            try {
                dir.mkdirs();
                InputStream in = GT4Reimagined.class.getResourceAsStream("/assets/gtsp/programmer_art.zip");
